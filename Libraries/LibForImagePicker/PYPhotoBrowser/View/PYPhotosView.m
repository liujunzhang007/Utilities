...
//        [addImage setBackgroundImage:PYAddImage forState:UIControlStateNormal];
        [addImage setImage:[UIImage imageNamed:@"publishing_addImage"] forState:UIControlStateNormal];
        [addImage addTarget:self action:@selector(addImageDidClicked) forControlEvents:UIControlEventTouchUpInside];
        addImage.backgroundColor = [UIColor colorWithRed:230/255.0 green:230/255.0 blue:230/255.0 alpha:1];
